...
class AdvModule(StanceModule):
    ...
    def get_optimizer_params(self):
        ...
        new_params = chain(self.classifier.parameters(), self.domain_head.parameters())
        return [
    ...
    def training_step(self, batch, batch_idx):
        ...
        loss = self.adv_weight * adv_loss_val + stance_loss_val
    ...
    def forward(self, **kwargs):
        ...
        transformed = last_hidden_state[:, 0]
        stance_logits = self.classifier(transformed)
        dom_logits = self.domain_head(self.grl(transformed))
